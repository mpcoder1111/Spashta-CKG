...
def build_containment_map(graph):
    ...
    # All edge types that express ownership/containment (File→Class, Class→Method, Class→Field, etc.)
    ownership_edges = {"defines", "contains_class", "contains_method", "contains_member",
                       "contains_variable", "has_field", "contains_field", "contains_constant"}
    ...
    for e in graph.get("edges", []):
        ...
        if typ in ownership_edges and src and tgt:
